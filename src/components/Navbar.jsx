    ...
    return (
        <div className='max-w-[1640] mx-auto flex justify-between items-center p-4'>
            ...
            <div className='flex items-center'>
                ...
                <h1 className='text-2xl font-bold sm:text-3xl lg:text-4xl mx-3'>
                    Best <span className='font-bold text-orange-600'>Eats</span>
                </h1>
                <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[12px] cursor-pointer ml-4'>
                    {delivery ? <div><a onClick={()=>setdelivery(!delivery)} className='bg-black text-white rounded-full p-2 duration-300'>Delivery</a><a onClick={()=>setdelivery(!delivery)} className='p-2'>Pickup</a></div> : <div><a onClick={()=>setdelivery(!delivery)} className='p-2'>Delivery</a><a onClick={()=>setdelivery(!delivery)} className='bg-black text-white rounded-full p-2 duration-300'>Pickup</a></div>}
                </div>
            </div>
            ...
            <div className={nav? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300': 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
                ...
                <nav>
                    <ul className='flex flex-col p-4 text-gray-800'>
                        ...
                        <li className='text-xl py-4 flex cursor-pointer'><MdFavorite size={25} className='mr-4'/> Favorite</li>
