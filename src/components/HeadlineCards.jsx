...
const HeadlineCards = () => {
    return (
        <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
            {/* Card */}
            <div className='rounded-xl relative border shadow-xl hover:scale-105 duration-300'>
                {/* Overlay */}
            ...
            {/* Card */}
            <div className='rounded-xl relative shadow-xl hover:scale-105 duration-300'>
                {/* Overlay */}
                <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
